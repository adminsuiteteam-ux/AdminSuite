...
export function IncomeExpenseChart({ data, formatValue, height = 200 }: { data: { label: string; income: number; expense: number }[]; formatValue: (v: number) => string; height?: number }) {
